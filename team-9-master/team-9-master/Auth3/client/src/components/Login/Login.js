...
const Login = () => {
   ...
   const handleChange=(event)=>{
        ...
        const handleSubmit=(event)=>{
            ...
            const url = `http://localhost:1086/login/?type=login&users=${user.user_name}&pass=${user.password}`;
            ...
            alert("You haven't registered yet, please register..");
                ...
                alert("You have Logged in successfully");
                window.location.href='/underprocessidea';
            }
...
<div className="bodyy">
    ...
    <br/>
    <br/>
    <h1 className="second_h1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login to Your Client Account</h1><br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br/><br/>
    &nbsp;&nbsp;&nbsp;
    <input type='button' onClick={handleSubmit2} value='Sign in as Admin' className="but_style" onMouseLeave={mouseEvent} onMouseOver={mouseEvent2}/>
...
<br/>
    ...
    <br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input id='signup' type='button' onClick={handleClick2} value='Sign Up' className="but_style3" onMouseLeave={mouseEvent4} onMouseOver={mouseEvent3}/>
